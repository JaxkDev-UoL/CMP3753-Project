...
DATASET_PATH = "datasets/mcv/100k_minecraft_villager_dataset_formatted_6-llama.jsonl"
OUTPUT_DIR = "./finetuned/22_results"
...
with torch.no_grad():
    ...
    new_embeddings[old_emb_size:] = new_embeddings[:old_emb_size].mean(dim=0)*1.1
